        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="reservation.php">การจองออนไลน์</a></li>
       ...
       <div class='row'>
        ...
        <div class='col-md-5 well'>
         <form action="" method="post" name="room_category">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" class="btn btn-primary button" name="submit">ตรวจสอบความพร้อมของพัก</button>
                ...
                while($row = mysqli_fetch_array($result))
                {
                   ...
                   echo "
                            ...
                            <div class='col-md-5 well'>
                                ...
                                <h6>จำนวนเตียง: ".$row2['no_bed']." ".$row2['bedtype']." bed.</h6>
                                <h6>ห้องว่าง: ".$row2['available']."</h6>
                                <h6>สิ่งอำนวยความสะดวก: ".$row2['facility']."</h6>
                                <h6>ราคา: ".$row2['price']." บาท/คืน.</h6>
                            </div>
                            <div class='col-md-3'>
                                <a href='./booknow.php?roomname=".$row2['roomname']."'><button class='btn btn-primary button'>จองเลย</button></a>
                            </div>   
                            </div>
